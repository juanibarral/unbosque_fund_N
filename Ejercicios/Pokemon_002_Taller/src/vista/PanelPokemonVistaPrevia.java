...
public class PanelPokemonVistaPrevia extends JPanel {
	...
	public void inicializarPanel(String imagen, String pNombre, int pTipo, int ataque, int defensa, double puntosDeVida, int nivel)
	{
		...
		String tipo = pTipo + "";
		//TODO D1: Agregue el código para actualizar la variable tipo 
		// para el tipo agua la variable debe tener el valor agua
		// para el tipo fuego la variable debe tener el valor fuego
		// para el tipo planta la variable debe tener el valor planta
